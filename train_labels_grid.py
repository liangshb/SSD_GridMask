...
from ssd.data.build_labels_grid import make_data_loader
from ssd.engine.trainer_grid import do_train
from ssd.modeling.detector.ssd_detector_grid import SSDDetector
...
resource.setrlimit(resource.RLIMIT_NOFILE, (rlimit[1]/2, rlimit[1]))
